...
HRESULT CDX9RenderingEngine::CreateIccProfileLut(TCHAR* profilePath, float* lut3D)
{
    ...
    unsigned short* lut3DOutput = NULL;
    unsigned short* lut3DInput  = NULL;

    try {
        // Create the 3D LUT input
        lut3DOutput = new unsigned short[m_Lut3DEntryCount * 3];
        lut3DInput  = new unsigned short[m_Lut3DEntryCount * 3];
