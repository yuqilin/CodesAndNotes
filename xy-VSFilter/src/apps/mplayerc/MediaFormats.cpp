...
#define ADDFMT(f) Add(CMediaFormatCategory##f)
		...
		ADDFMT((_T("MPEG Media file"),          _T("mpg mpeg mpe m1v m2v mpv2 mp2v ts tp tpr pva m2ts m2t mts evo m2p")));
		...
		ADDFMT((_T("MPEG4 Audio file"),         _T("m4a m4b aac"), true, _T(""), QuickTime));
		...
		ADDFMT((_T("Quicktime file"),           _T("mov 3g2 3gp2"), false, _T("QuickTime (Alternative)"), QuickTime));
