; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\GitHub\codesandnotes\xy-vsfilter\src\filters\BaseClasses\amextra.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG79846 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'e', 00H
	DB	'x', 00H, 't', 00H, 'r', 00H, 'a', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79847 DB	'(', 00H, '(', 00H, '(', 00H, 'H', 00H, 'R', 00H, 'E', 00H
...
$SG79867 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'e', 00H
	DB	'x', 00H, 't', 00H, 'r', 00H, 'a', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79868 DB	'm', 00H, '_', 00H, 'b', 00H, 'A', 00H, 't', 00H, 'E', 00H
...
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\amextra.cpp
rdata$r	SEGMENT
...
_phr$ = 20						; size = 4
_pName$ = 24						; size = 4
??0CRenderedInputPin@@QAE@PA_WPAVCBaseFilter@@PAVCCritSec@@PAJPB_W@Z PROC ; CRenderedInputPin::CRenderedInputPin
; _this$ = ecx
; Line 29
	push	ebp
	mov	ebp, esp
...
_phr$ = 20						; size = 4
_pName$ = 24						; size = 4
??0CRenderedInputPin@@QAE@PADPAVCBaseFilter@@PAVCCritSec@@PAJPB_W@Z PROC ; CRenderedInputPin::CRenderedInputPin
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\amextra.cpp
; Line 40
	push	ebp
...
_hr$ = -4						; size = 4
_this$ = 8						; size = 4
?EndOfStream@CRenderedInputPin@@UAGJXZ PROC		; CRenderedInputPin::EndOfStream
; Line 48
	push	ebp
	mov	ebp, esp
...
; Line 55
	mov	esi, esp
	lea	eax, DWORD PTR _fs$79843[ebp]
	push	eax
	push	0
	mov	ecx, DWORD PTR _this$[ebp]
...
__$EHRec$ = -12						; size = 12
_this$ = 8						; size = 4
?EndFlush@CRenderedInputPin@@UAGJXZ PROC		; CRenderedInputPin::EndFlush
; Line 67
	push	ebp
	mov	ebp, esp
	push	-1
...
; Line 74
	...
	mov	DWORD PTR $T80263[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lck$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80263[ebp]
; Line 75
	push	edx
	mov	ecx, ebp
	push	eax
...
_this$ = -4						; size = 4
_tStart$ = 8						; size = 8
?Run@CRenderedInputPin@@UAEJ_J@Z PROC			; CRenderedInputPin::Run
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\amextra.cpp
; Line 81
	push	ebp
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Active@CRenderedInputPin@@UAEJXZ PROC			; CRenderedInputPin::Active
; _this$ = ecx
; Line 94
	push	ebp
	mov	ebp, esp
...
tv89 = -8						; size = 4
_this$ = -4						; size = 4
?DoCompleteHandling@CRenderedInputPin@@AAEXXZ PROC	; CRenderedInputPin::DoCompleteHandling
; _this$ = ecx
; Line 104
	push	ebp
	mov	ebp, esp
