; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\GitHub\codesandnotes\xy-vsfilter\src\filters\BaseClasses\combase.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_szOle32Aut DB	'O', 00H, 'l', 00H, 'e', 00H, 'A', 00H, 'u', 00H, 't', 00H
	...
	DB	00H
	ORG $+2
$SG79875 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79876 DB	'"', 00H, 'I', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'r', 00H, 'e', 00H, 'a', 00H, 'd'
	DB	00H, ' ', 00H, 'p', 00H, 'o', 00H, 'i', 00H, 'n', 00H, 't', 00H
	DB	'e', 00H, 'r', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG79880 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79881 DB	'"', 00H, 'I', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'w', 00H, 'r', 00H, 'i', 00H, 't'
	DB	00H, 'e', 00H, ' ', 00H, 'p', 00H, 'o', 00H, 'i', 00H, 'n', 00H
	DB	't', 00H, 'e', 00H, 'r', 00H, '"', 00H, 00H, 00H
$SG79895 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79896 DB	'l', 00H, 'R', 00H, 'e', 00H, 'f', 00H, ' ', 00H, '>', 00H
	DB	' ', 00H, '0', 00H, 00H, 00H
	ORG $+2
$SG79897 DB	' ', 00H, ' ', 00H, ' ', 00H, ' ', 00H, 'O', 00H, 'b', 00H
	DB	'j', 00H, ' ', 00H, '%', 00H, 'd', 00H, ' ', 00H, 'r', 00H, 'e'
	DB	00H, 'f', 00H, '+', 00H, '+', 00H, ' ', 00H, '=', 00H, ' ', 00H
	DB	'%', 00H, 'd', 00H, 00H, 00H
$SG79910 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79911 DB	'l', 00H, 'R', 00H, 'e', 00H, 'f', 00H, ' ', 00H, '>', 00H
	DB	'=', 00H, ' ', 00H, '0', 00H, 00H, 00H
$SG79912 DB	' ', 00H, ' ', 00H, ' ', 00H, ' ', 00H, 'O', 00H, 'b', 00H
	DB	'j', 00H, 'e', 00H, 'c', 00H, 't', 00H, ' ', 00H, '%', 00H, 'd'
	DB	00H, ' ', 00H, 'r', 00H, 'e', 00H, 'f', 00H, '-', 00H, '-', 00H
	DB	' ', 00H, '=', 00H, ' ', 00H, '%', 00H, 'd', 00H, 00H, 00H
	ORG $+2
$SG79934 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79935 DB	'p', 00H, 'F', 00H, 'i', 00H, 'r', 00H, 's', 00H, 't', 00H
	DB	00H, 00H
	ORG $+2
$SG79937 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79938 DB	'p', 00H, 'S', 00H, 'e', 00H, 'c', 00H, 'o', 00H, 'n', 00H
	DB	'd', 00H, 00H, 00H
$SG79942 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79943 DB	'S', 00H, 'U', 00H, 'C', 00H, 'C', 00H, 'E', 00H, 'E', 00H
	DB	'D', 00H, 'E', 00H, 'D', 00H, '(', 00H, 'h', 00H, 'r', 00H, ')'
	DB	00H, 00H, 00H
$SG79945 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79946 DB	'p', 00H, 'U', 00H, 'n', 00H, 'k', 00H, 'n', 00H, 'o', 00H
	DB	'w', 00H, 'n', 00H, '1', 00H, 00H, 00H
$SG79950 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79951 DB	'S', 00H, 'U', 00H, 'C', 00H, 'C', 00H, 'E', 00H, 'E', 00H
	DB	'D', 00H, 'E', 00H, 'D', 00H, '(', 00H, 'h', 00H, 'r', 00H, ')'
	DB	00H, 00H, 00H
$SG79953 DB	'.', 00H, '.', 00H, '\', 00H, 'c', 00H, 'o', 00H, 'm', 00H
	DB	'b', 00H, 'a', 00H, 's', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79954 DB	'p', 00H, 'U', 00H, 'n', 00H, 'k', 00H, 'n', 00H, 'o', 00H
...
;	COMDAT rtc$TMZ
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\combase.cpp
rtc$TMZ	SEGMENT
...
_this$ = -4						; size = 4
_pName$ = 8						; size = 4
??0CBaseObject@@QAE@PB_W@Z PROC				; CBaseObject::CBaseObject
; _this$ = ecx
; Line 23
	push	ebp
	mov	ebp, esp
...
_this$ = -4						; size = 4
_pName$ = 8						; size = 4
??0CBaseObject@@QAE@PBD@Z PROC				; CBaseObject::CBaseObject
; _this$ = ecx
; Line 40
	push	ebp
	mov	ebp, esp
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1CBaseObject@@QAE@XZ PROC				; CBaseObject::~CBaseObject
; _this$ = ecx
; Line 55
	push	ebp
	mov	ebp, esp
...
; Function compile flags: /Odtp /RTCsu
_TEXT	SEGMENT
?LoadOLEAut32@@YGPAUHINSTANCE__@@XZ PROC		; LoadOLEAut32
; Line 74
	push	ebp
	mov	ebp, esp
	push	esi
...
_pName$ = 8						; size = 4
_pUnk$ = 12						; size = 4
??0CUnknown@@QAE@PB_WPAUIUnknown@@@Z PROC		; CUnknown::CUnknown
; _this$ = ecx
; Line 104
	push	ebp
	mov	ebp, esp
...
_pUnk$ = 12						; size = 4
_phr$ = 16						; size = 4
??0CUnknown@@QAE@PA_WPAUIUnknown@@PAJ@Z PROC		; CUnknown::CUnknown
; _this$ = ecx
; Line 114
	push	ebp
	mov	ebp, esp
...
_pName$ = 8						; size = 4
_pUnk$ = 12						; size = 4
??0CUnknown@@QAE@PBDPAUIUnknown@@@Z PROC		; CUnknown::CUnknown
; _this$ = ecx
; Line 121
	push	ebp
	mov	ebp, esp
...
_pUnk$ = 12						; size = 4
_phr$ = 16						; size = 4
??0CUnknown@@QAE@PADPAUIUnknown@@PAJ@Z PROC		; CUnknown::CUnknown
; _this$ = ecx
; Line 126
	push	ebp
	mov	ebp, esp
...
_riid$ = 12						; size = 4
_ppv$ = 16						; size = 4
?NonDelegatingQueryInterface@CUnknown@@UAGJABU_GUID@@PAPAX@Z PROC ; CUnknown::NonDelegatingQueryInterface
; Line 136
	push	ebp
	mov	ebp, esp
	push	esi
...
_lRef$ = -4						; size = 4
_this$ = 8						; size = 4
?NonDelegatingAddRef@CUnknown@@UAGKXZ PROC		; CUnknown::NonDelegatingAddRef
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\combase.cpp
; Line 164
	push	ebp
	mov	ebp, esp
...
; Line 169
	mov	DWORD PTR $T80267[ebp], 1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+12]
	mov	DWORD PTR $T80268[ebp], eax
	lea	ecx, DWORD PTR $T80267[ebp]
	push	ecx
	lea	edx, DWORD PTR $T80268[ebp]
	push	edx
...
_lRef$ = -4						; size = 4
_this$ = 8						; size = 4
?NonDelegatingRelease@CUnknown@@UAGKXZ PROC		; CUnknown::NonDelegatingRelease
; Line 176
	push	ebp
	mov	ebp, esp
...
; Line 200
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T80271[ebp], edx
	mov	eax, DWORD PTR $T80271[ebp]
	mov	DWORD PTR $T80270[ebp], eax
	cmp	DWORD PTR $T80270[ebp], 0
	je	SHORT $LN6@NonDelegat@3
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T80270[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T80270[ebp]
	mov	eax, DWORD PTR [edx+12]
	call	eax
...
$LN2@NonDelegat@3:
; Line 203
	mov	DWORD PTR $T80274[ebp], 1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+12]
	mov	DWORD PTR $T80275[ebp], edx
	lea	eax, DWORD PTR $T80274[ebp]
	push	eax
	lea	ecx, DWORD PTR $T80275[ebp]
	push	ecx
	call	??$ourmax@K@@YGKABK0@Z			; ourmax<unsigned long>
$LN4@NonDelegat@3:
; Line 205
...
_pFirst$ = 8						; size = 4
_pSecond$ = 12						; size = 4
?IsEqualObject@@YGHPAUIUnknown@@0@Z PROC		; IsEqualObject
; Line 223
	push	ebp
	mov	ebp, esp
...
_a$ = 8							; size = 4
_b$ = 12						; size = 4
??$ourmax@K@@YGKABK0@Z PROC				; ourmax<unsigned long>
; Line 157
	push	ebp
	mov	ebp, esp
	push	ecx
