; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\GitHub\codesandnotes\xy-vsfilter\src\filters\BaseClasses\pstream.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG79857 DB	'%', 00H, '0', 00H, '1', 00H, '1', 00H, 'd', 00H, ' ', 00H
	DB	00H, 00H
CONST	ENDS
...
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pstream.cpp
rdata$r	SEGMENT
...
_punk$ = 8						; size = 4
_phr$ = 12						; size = 4
??0CPersistStream@@QAE@PAUIUnknown@@PAJ@Z PROC		; CPersistStream::CPersistStream
; _this$ = ecx
; Line 22
	push	ebp
	mov	ebp, esp
...
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pstream.h
; Line 61
	push	ebp
	mov	ebp, esp
	mov	eax, DWORD PTR _this$[ebp]
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1CPersistStream@@QAE@XZ PROC				; CPersistStream::~CPersistStream
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pstream.cpp
; Line 30
	push	ebp
...
_this$ = -4						; size = 4
_pStream$ = 8						; size = 4
?WriteToStream@CPersistStream@@UAEJPAUIStream@@@Z PROC	; CPersistStream::WriteToStream
; _this$ = ecx
; Line 61
	push	ebp
	mov	ebp, esp
...
_this$ = -4						; size = 4
_pStream$ = 8						; size = 4
?ReadFromStream@CPersistStream@@UAEJPAUIStream@@@Z PROC	; CPersistStream::ReadFromStream
; _this$ = ecx
; Line 71
	push	ebp
	mov	ebp, esp
...
_this$ = 8						; size = 4
_pStm$ = 12						; size = 4
?Load@CPersistStream@@UAGJPAUIStream@@@Z PROC		; CPersistStream::Load
; Line 84
	push	ebp
	mov	ebp, esp
...
?Save@CPersistStream@@UAGJPAUIStream@@H@Z PROC		; CPersistStream::Save
; Line 102
	push	ebp
	mov	ebp, esp
	push	ecx
