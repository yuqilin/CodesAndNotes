; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\GitHub\codesandnotes\xy-vsfilter\src\filters\BaseClasses\ddmm.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT rtc$TMZ
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\ddmm.cpp
rtc$TMZ	SEGMENT
...
_szDevice$ = 16						; size = 4
_lParam$ = 20						; size = 4
?FindDeviceCallback@@YGHPAU_GUID@@PAD1PAX@Z PROC	; FindDeviceCallback
; Line 26
	push	ebp
	mov	ebp, esp
	push	ecx
...
_lParam$ = 20						; size = 4
_hMonitor$ = 24						; size = 4
?FindDeviceCallbackEx@@YGHPAU_GUID@@PAD1PAXPAUHMONITOR__@@@Z PROC ; FindDeviceCallbackEx
; Line 44
	push	ebp
	mov	ebp, esp
	push	ecx
...
_DirectDrawCreateFromDevice@12 PROC
; Line 67
	push	ebp
	mov	ebp, esp
...
; Line 87
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _ErrorMode$79876[ebp], eax
; Line 88
	mov	esi, esp
	push	0
	lea	eax, DWORD PTR _pdd$[ebp]
...
; Line 89
	mov	esi, esp
	mov	edx, DWORD PTR _ErrorMode$79876[ebp]
	push	edx
	call	DWORD PTR __imp__SetErrorMode@4
	cmp	esi, esp
	call	__RTC_CheckEsp
...
_DirectDrawCreateFromDeviceEx@12 PROC
; Line 102
	push	ebp
	mov	ebp, esp
	sub	esp, 56					; 00000038H
...
; Line 123
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _ErrorMode$79887[ebp], eax
; Line 124
	mov	esi, esp
	push	0
	lea	eax, DWORD PTR _pdd$[ebp]
...
; Line 125
	mov	esi, esp
	mov	edx, DWORD PTR _ErrorMode$79887[ebp]
	push	edx
	call	DWORD PTR __imp__SetErrorMode@4
	cmp	esi, esp
	call	__RTC_CheckEsp
