; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\GitHub\codesandnotes\xy-vsfilter\src\filters\BaseClasses\pullpin.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG79957 DB	'.', 00H, '.', 00H, '\', 00H, 'p', 00H, 'u', 00H, 'l', 00H
	DB	'l', 00H, 'p', 00H, 'i', 00H, 'n', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79958 DB	'!', 00H, 'T', 00H, 'h', 00H, 'r', 00H, 'e', 00H, 'a', 00H
...
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pullpin.cpp
rdata$r	SEGMENT
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??0CPullPin@@QAE@XZ PROC				; CPullPin::CPullPin
; _this$ = ecx
; Line 20
	push	ebp
	mov	ebp, esp
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
??1CPullPin@@UAE@XZ PROC				; CPullPin::~CPullPin
; _this$ = ecx
; Line 24
	push	ebp
	mov	ebp, esp
...
_pAlloc$ = 12						; size = 4
_bSync$ = 16						; size = 4
?Connect@CPullPin@@QAEJPAUIUnknown@@PAUIMemAllocator@@H@Z PROC ; CPullPin::Connect
; _this$ = ecx
; Line 34
	push	ebp
	mov	ebp, esp
...
; Line 38
	mov	DWORD PTR $T80457[ebp], -2147220988	; 80040204H
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80457[ebp]
	jmp	$LN5@Connect
$LN4@Connect:
; Line 41
	mov	edx, DWORD PTR _this$[ebp]
...
; Line 43
	...
	mov	DWORD PTR $T80458[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80458[ebp]
	jmp	$LN5@Connect
$LN3@Connect:
; Line 46
	mov	esi, esp
...
; Line 66
	mov	DWORD PTR $T80461[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80461[ebp]
$LN5@Connect:
; Line 67
	push	edx
	mov	ecx, ebp
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?Disconnect@CPullPin@@QAEJXZ PROC			; CPullPin::Disconnect
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pullpin.cpp
; Line 72
	push	ebp
...
_pAlloc$ = 8						; size = 4
_pProps$ = 12						; size = 4
?DecideAllocator@CPullPin@@UAEJPAUIMemAllocator@@PAU_AllocatorProperties@@@Z PROC ; CPullPin::DecideAllocator
; _this$ = ecx
; Line 99
	push	ebp
	mov	ebp, esp
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Active@CPullPin@@QAEJXZ PROC				; CPullPin::Active
; _this$ = ecx
; Line 121
	push	ebp
	mov	ebp, esp
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Inactive@CPullPin@@QAEJXZ PROC				; CPullPin::Inactive
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pullpin.cpp
; Line 129
	push	ebp
...
_tStart$ = 8						; size = 8
_tStop$ = 16						; size = 8
?Seek@CPullPin@@QAEJ_J0@Z PROC				; CPullPin::Seek
; _this$ = ecx
; Line 137
	push	ebp
	mov	ebp, esp
...
?Duration@CPullPin@@QAEJPA_J@Z PROC			; CPullPin::Duration
; _this$ = ecx
; Line 161
	push	ebp
	mov	ebp, esp
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?StartThread@CPullPin@@AAEJXZ PROC			; CPullPin::StartThread
; _this$ = ecx
; Line 169
	push	ebp
	mov	ebp, esp
...
$LN4@StartThrea:
; Line 173
	mov	DWORD PTR $T80509[ebp], -2147418113	; 8000ffffH
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80509[ebp]
	jmp	$LN6@StartThrea
$LN5@StartThrea:
; Line 177
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 182
	mov	eax, DWORD PTR _hr$[ebp]
	mov	DWORD PTR $T80510[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80510[ebp]
...
; Line 186
	...
	jne	SHORT $LN3@StartThrea
; Line 187
	mov	DWORD PTR $T80511[ebp], -2147467259	; 80004005H
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80511[ebp]
	jmp	SHORT $LN6@StartThrea
$LN3@StartThrea:
; Line 191
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 193
	mov	ecx, DWORD PTR _hr$[ebp]
	mov	DWORD PTR $T80512[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80512[ebp]
$LN6@StartThrea:
; Line 194
	push	edx
	mov	ecx, ebp
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?PauseThread@CPullPin@@AAEJXZ PROC			; CPullPin::PauseThread
; _this$ = ecx
; Line 198
	push	ebp
	mov	ebp, esp
...
; Line 202
	mov	DWORD PTR $T80522[ebp], -2147418113	; 8000ffffH
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80522[ebp]
	jmp	$LN3@PauseThrea
$LN2@PauseThrea:
; Line 207
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 209
	mov	ecx, DWORD PTR _hr$[ebp]
	mov	DWORD PTR $T80523[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80523[ebp]
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?StopThread@CPullPin@@AAEJXZ PROC			; CPullPin::StopThread
; _this$ = ecx
; Line 221
	push	ebp
	mov	ebp, esp
...
; Line 232
	mov	ecx, DWORD PTR _hr$[ebp]
	mov	DWORD PTR $T80535[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80535[ebp]
	jmp	$LN4@StopThread
$LN2@StopThread:
; Line 235
	mov	edx, DWORD PTR _this$[ebp]
...
$LN1@StopThread:
; Line 248
	mov	DWORD PTR $T80536[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1CAutoLock@@QAE@XZ			; CAutoLock::~CAutoLock
	mov	eax, DWORD PTR $T80536[ebp]
$LN4@StopThread:
; Line 249
	push	edx
	mov	ecx, ebp
...
_cmd$80032 = -8						; size = 4
_this$ = -4						; size = 4
?ThreadProc@CPullPin@@EAEKXZ PROC			; CPullPin::ThreadProc
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pullpin.cpp
; Line 254
	push	ebp
...
; Line 256
	...
	mov	DWORD PTR _cmd$80032[ebp], eax
; Line 257
	mov	ecx, DWORD PTR _cmd$80032[ebp]
...
?QueueSample@CPullPin@@AAEJAA_J_JH@Z PROC		; CPullPin::QueueSample
; _this$ = ecx
; Line 291
	push	ebp
	mov	ebp, esp
...
_tStart$ = 8						; size = 8
_tStop$ = 16						; size = 8
?CollectAndDeliver@CPullPin@@AAEJ_J0@Z PROC		; CPullPin::CollectAndDeliver
; _this$ = ecx
; Line 324
	push	ebp
	mov	ebp, esp
...
_tStart$ = 12						; size = 8
_tStop$ = 20						; size = 8
?DeliverSample@CPullPin@@AAEJPAUIMediaSample@@_J1@Z PROC ; CPullPin::DeliverSample
; _this$ = ecx
; Line 352
	push	ebp
	mov	ebp, esp
...
tv258 = -128						; size = 4
tv257 = -124						; size = 4
_tStopThis$80121 = -116					; size = 8
_pSample$80118 = -100					; size = 4
...
_this$ = -8						; size = 4
__$ArrayPad$ = -4					; size = 4
?Process@CPullPin@@AAEXXZ PROC				; CPullPin::Process
; _this$ = ecx
; Line 373
	push	ebp
	mov	ebp, esp
...
; Line 468
	...
	push	0
	push	0
	lea	eax, DWORD PTR _pSample$80118[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+136]
	mov	eax, DWORD PTR _this$[ebp]
...
$LN6@Process:
; Line 474
	mov	eax, DWORD PTR _pSample$80118[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	esi, esp
	mov	edx, DWORD PTR _pSample$80118[ebp]
	push	edx
	...
	mov	DWORD PTR _tStopThis$80121[ebp], eax
	mov	DWORD PTR _tStopThis$80121[ebp+4], edx
; Line 475
	mov	ecx, DWORD PTR _tStopThis$80121[ebp+4]
	cmp	ecx, DWORD PTR _tAlignStop$[ebp+4]
	jl	SHORT $LN5@Process
	jg	SHORT $LN32@Process
	mov	edx, DWORD PTR _tStopThis$80121[ebp]
	cmp	edx, DWORD PTR _tAlignStop$[ebp]
...
; Line 476
	...
	mov	DWORD PTR _tStopThis$80121[ebp], eax
	mov	ecx, DWORD PTR _tAlignStop$[ebp+4]
	mov	DWORD PTR _tStopThis$80121[ebp+4], ecx
$LN5@Process:
; Line 478
	mov	esi, esp
	lea	edx, DWORD PTR _tStopThis$80121[ebp]
	push	edx
	lea	eax, DWORD PTR _tCurrent$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pSample$80118[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	eax, DWORD PTR _pSample$80118[ebp]
	push	eax
	mov	ecx, DWORD PTR [edx+24]
...
; Line 479
	mov	edx, DWORD PTR _tStopThis$80121[ebp]
	mov	DWORD PTR _tCurrent$[ebp], edx
	mov	eax, DWORD PTR _tStopThis$80121[ebp+4]
	mov	DWORD PTR _tCurrent$[ebp+4], eax
; Line 481
...
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pullpin.h
; Line 114
	push	ebp
	mov	ebp, esp
	push	ecx
...
_TEXT	SEGMENT
_hr$80139 = -32						; size = 4
_dwUnused$80138 = -24					; size = 4
_pSample$80137 = -12					; size = 4
_this$ = -4						; size = 4
?CleanupCancelled@CPullPin@@AAEXXZ PROC			; CPullPin::CleanupCancelled
; _this$ = ecx
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\pullpin.cpp
; Line 511
	push	ebp
...
; Line 519
	mov	esi, esp
	lea	ecx, DWORD PTR _dwUnused$80138[ebp]
	push	ecx
	lea	edx, DWORD PTR _pSample$80137[ebp]
	push	edx
	push	0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+96]
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hr$80139[ebp], eax
; Line 520
	cmp	DWORD PTR _pSample$80137[ebp], 0
	je	SHORT $LN2@CleanupCan
; Line 521
	mov	eax, DWORD PTR _pSample$80137[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	esi, esp
	mov	edx, DWORD PTR _pSample$80137[ebp]
	push	edx
	mov	eax, DWORD PTR [ecx+8]
	call	eax
	cmp	esi, esp
