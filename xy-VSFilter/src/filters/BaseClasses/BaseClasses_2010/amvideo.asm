; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	E:\GitHub\codesandnotes\xy-vsfilter\src\filters\BaseClasses\amvideo.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?bits888@@3QBKB DD 0ff0000H				; bits888
	DD	0ff00H
	DD	0ffH
$SG79827 DB	'RGB Monochrome', 00H
	ORG $+1
$SG79828 DB	'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, 'M', 00H, 'o', 00H
	DB	'n', 00H, 'o', 00H, 'c', 00H, 'h', 00H, 'r', 00H, 'o', 00H, 'm'
	DB	00H, 'e', 00H, 00H, 00H
	ORG $+2
$SG79829 DB	'RGB VGA', 00H
$SG79830 DB	'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, 'V', 00H, 'G', 00H
	DB	'A', 00H, 00H, 00H
$SG79831 DB	'RGB 8', 00H
	ORG $+2
$SG79832 DB	'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, '8', 00H, 00H, 00H
$SG79833 DB	'RGB 565 (16 bit)', 00H
	ORG $+3
$SG79834 DB	'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, '5', 00H, '6', 00H
	DB	'5', 00H, ' ', 00H, '(', 00H, '1', 00H, '6', 00H, ' ', 00H, 'b'
	DB	00H, 'i', 00H, 't', 00H, ')', 00H, 00H, 00H
	ORG $+2
$SG79835 DB	'RGB 555 (16 bit)', 00H
	ORG $+3
$SG79836 DB	'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, '5', 00H, '5', 00H
	DB	'5', 00H, ' ', 00H, '(', 00H, '1', 00H, '6', 00H, ' ', 00H, 'b'
	DB	00H, 'i', 00H, 't', 00H, ')', 00H, 00H, 00H
	ORG $+2
$SG79837 DB	'RGB 24', 00H
	ORG $+1
$SG79838 DB	'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, '2', 00H, '4', 00H
	DB	00H, 00H
	ORG $+2
$SG79839 DB	'RGB 32', 00H
	ORG $+1
$SG79840 DB	'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, '3', 00H, '2', 00H
	DB	00H, 00H
	ORG $+2
$SG79841 DB	'ARGB 32', 00H
$SG79842 DB	'A', 00H, 'R', 00H, 'G', 00H, 'B', 00H, ' ', 00H, '3', 00H
	DB	'2', 00H, 00H, 00H
$SG79843 DB	'Overlay', 00H
$SG79844 DB	'O', 00H, 'v', 00H, 'e', 00H, 'r', 00H, 'l', 00H, 'a', 00H
	DB	'y', 00H, 00H, 00H
$SG79845 DB	'UNKNOWN', 00H
$SG79846 DB	'U', 00H, 'N', 00H, 'K', 00H, 'N', 00H, 'O', 00H, 'W', 00H
	DB	'N', 00H, 00H, 00H
_BitCountMap DD	FLAT:_MEDIASUBTYPE_RGB1
	...
	DD	FLAT:$SG79845
	DD	FLAT:$SG79846
$SG79866 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'v', 00H
	DB	'i', 00H, 'd', 00H, 'e', 00H, 'o', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79867 DB	'p', 00H, 'b', 00H, 'm', 00H, 'i', 00H, 'H', 00H, 'e', 00H
	...
	ORG $+2
$SG79882 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'v', 00H
	DB	'i', 00H, 'd', 00H, 'e', 00H, 'o', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79883 DB	'p', 00H, 'b', 00H, 'm', 00H, 'i', 00H, 'H', 00H, 'e', 00H
	DB	'a', 00H, 'd', 00H, 'e', 00H, 'r', 00H, 00H, 00H
	ORG $+2
$SG79904 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'v', 00H
	DB	'i', 00H, 'd', 00H, 'e', 00H, 'o', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79905 DB	'p', 00H, 'S', 00H, 'u', 00H, 'b', 00H, 't', 00H, 'y', 00H
	DB	'p', 00H, 'e', 00H, 00H, 00H
	ORG $+2
$SG79917 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'v', 00H
	DB	'i', 00H, 'd', 00H, 'e', 00H, 'o', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79918 DB	'p', 00H, 'S', 00H, 'u', 00H, 'b', 00H, 't', 00H, 'y', 00H
	DB	'p', 00H, 'e', 00H, 00H, 00H
	ORG $+2
$SG79944 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'v', 00H
	DB	'i', 00H, 'd', 00H, 'e', 00H, 'o', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+6
$SG79945 DB	'p', 00H, 'H', 00H, 'e', 00H, 'a', 00H, 'd', 00H, 'e', 00H
...
$SG79947 DB	'.', 00H, '.', 00H, '\', 00H, 'a', 00H, 'm', 00H, 'v', 00H
	DB	'i', 00H, 'd', 00H, 'e', 00H, 'o', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG79948 DB	'p', 00H, 'H', 00H, 'e', 00H, 'a', 00H, 'd', 00H, 'e', 00H
...
;	COMDAT rtc$TMZ
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\amvideo.cpp
rtc$TMZ	SEGMENT
...
$T79897 = -60						; size = 16
$T79888 = -44						; size = 16
_FourCCMap$79886 = -24					; size = 16
__$ArrayPad$ = -4					; size = 4
$T80253 = 8						; size = 4
_pbmiHeader$ = 12					; size = 4
_GetBitmapSubtype@4 PROC
; Line 94
	push	ebp
	mov	ebp, esp
...
; Line 101
	...
	push	eax
	lea	ecx, DWORD PTR _FourCCMap$79886[ebp]
	call	??0FOURCCMap@@QAE@K@Z			; FOURCCMap::FOURCCMap
; Line 102
	mov	ecx, DWORD PTR _FourCCMap$79886[ebp]
	mov	DWORD PTR $T79888[ebp], ecx
	mov	edx, DWORD PTR _FourCCMap$79886[ebp+4]
	mov	DWORD PTR $T79888[ebp+4], edx
	mov	eax, DWORD PTR _FourCCMap$79886[ebp+8]
	mov	DWORD PTR $T79888[ebp+8], eax
	mov	ecx, DWORD PTR _FourCCMap$79886[ebp+12]
	mov	DWORD PTR $T79888[ebp+12], ecx
	mov	edx, DWORD PTR $T80253[ebp]
	mov	eax, DWORD PTR $T79888[ebp]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR $T79888[ebp+4]
	mov	DWORD PTR [edx+4], ecx
	mov	eax, DWORD PTR $T79888[ebp+8]
	mov	DWORD PTR [edx+8], eax
	mov	ecx, DWORD PTR $T79888[ebp+12]
	mov	DWORD PTR [edx+12], ecx
	mov	eax, DWORD PTR $T80253[ebp]
...
; Line 112
	mov	ecx, DWORD PTR _pbmiHeader$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T80254[ebp]
	push	edx
	call	_GetTrueColorType@4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T79897[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T79897[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T79897[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T79897[ebp+12], edx
	mov	eax, DWORD PTR $T80253[ebp]
	mov	ecx, DWORD PTR $T79897[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T79897[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T79897[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T79897[ebp+12]
	mov	DWORD PTR [eax+12], edx
	mov	eax, DWORD PTR $T80253[ebp]
...
_pMediaSubtype$ = -4					; size = 4
_pSubtype$ = 8						; size = 4
?LocateSubtype@@YGHPBU_GUID@@@Z PROC			; LocateSubtype
; File e:\github\codesandnotes\xy-vsfilter\src\filters\baseclasses\amvideo.cpp
; Line 151
	push	ebp
	mov	ebp, esp
...
; Function compile flags: /Odtp /RTCsu
_TEXT	SEGMENT
_Entries$79951 = -8					; size = 4
_Size$ = -4						; size = 4
_pHeader$ = 8						; size = 4
_GetBitmapFormatSize@4 PROC
; Line 214
	push	ebp
	mov	ebp, esp
	sub	esp, 8
...
; Line 229
	...
	mov	edx, 1
	shl	edx, cl
	mov	DWORD PTR _Entries$79951[ebp], edx
; Line 230
	mov	eax, DWORD PTR _pHeader$[ebp]
...
$LN2@GetBitmapF:
; Line 233
	mov	eax, DWORD PTR _Entries$79951[ebp]
