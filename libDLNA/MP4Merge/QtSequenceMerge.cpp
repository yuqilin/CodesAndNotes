...
QtSequence::QtSequence(SequenceInfo* pinfo)
{
	...
	{
		pdestinationbuffer = pinfo->pSectioninfo[0].pSectionInfoBuffer;
	...
	else
	{
		...
		//moov
		{
			...
			//mvhd
			{
				...
				for (_uint32_t i = 0; i < pinfo->nSectionCount; i++)
				{
					ui64Duration += pSectionHeader[i].moov.sMvhdAtom.ui64Duration;
				}
